...
namespace SFA.DAS.ApprenticeAccounts.TestMessagePublisher
{
    [ExcludeFromCodeCoverage]
    public static partial class Program
    {
        private const string QueueName = "SFA.DAS.ApprenticeAccounts";
        ...
        public static async Task Main()
        {
            ...
            var connectionString = config["Values:NServiceBusConnectionString"]
                                   ?? throw new NotSupportedException(
                                       "NServiceBusConnection should contain ServiceBus connection string");
        ...
        private static async Task PublishMessage(IMessageSession messageSession, object message)
        {
        ...
        private static async Task SendMessage(IMessageSession messageSession, object message)
        {
